...
router.post('/', (req, res) => {
    ...
    const query = 'INSERT INTO items_model_row (img, title, text) VALUES (?, ?, ?)';
...
router.get('/', (req, res) => {
    const query = 'SELECT * FROM items_model_row';
...
router.get('/', (req, res) => {
    const query = 'SELECT * FROM items_model_row WHERE id = ?';
...
router.put('/', (req, res) => {
    ...
    const query = 'UPDATE items_model_row SET img = ?, title = ?, text = ? WHERE id = ?';
...
router.delete('/', (req, res) => {
    const query = 'DELETE FROM items_model_row WHERE id = ?';
