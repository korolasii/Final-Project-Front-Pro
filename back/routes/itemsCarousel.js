...
router.post('/', (req, res) => {
    ...
    const query = 'INSERT INTO items_carousel (img, title, text) VALUES (?, ?, ?)';
...
router.get('/', (req, res) => {
    const query = 'SELECT * FROM items_carousel';
...
router.get('/', (req, res) => {
    const query = 'SELECT * FROM items_carousel WHERE id = ?';
...
router.put('/', (req, res) => {
    ...
    const query = 'UPDATE items_carousel SET img = ?, title = ?, text = ? WHERE id = ?';
...
router.delete('/', (req, res) => {
    const query = 'DELETE FROM items_carousel WHERE id = ?';
